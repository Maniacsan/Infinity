	...
	public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
		if (visible) {
			...
			if (n > 0) {
				...
				bufferBuilder.begin(7, VertexFormats.POSITION_TEXTURE_COLOR);
				bufferBuilder.vertex(i, bottom, 0.0D).texture(0.0F, 1.0F).color(0, 0, 0, 255).next();
				...
				bufferBuilder.vertex(i, top, 0.0D).texture(0.0F, 0.0F).color(0, 0, 0, 255).next();
				tessellator.draw();
				bufferBuilder.begin(7, VertexFormats.POSITION_TEXTURE_COLOR);
