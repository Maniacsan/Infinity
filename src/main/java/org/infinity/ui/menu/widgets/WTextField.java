package org.infinity.ui.menu.widgets;
...
public class WTextField {
	...
	public void render(MatrixStack matrices, int mouseX, int mouseY, float partialTicks) {
		if (focused)
			Render2D.drawRectWH(matrices, x, y, width, height, 0xFF212F55);
		Render2D.drawRectWH(matrices, x + 1, y + 1, width - 2, height - 2, color);
		...
		if (focused) {
			Render2D.drawRectWH(matrices, getX() + IFont.legacy14.getStringWidth(getText()) + 4 - diff,
