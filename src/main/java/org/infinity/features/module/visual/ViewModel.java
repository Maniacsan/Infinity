...
public class ViewModel extends Module {
	...
	private Setting x = new Setting(this, "X", 0D, 0D, 3D);
	private Setting y = new Setting(this, "Y", 0D, 0D, 3D);
	private Setting z = new Setting(this, "Z", 0D, 0D, 3D);

	private Setting scaleX = new Setting(this, "Scale X", 1D, 0D, 3D);
	private Setting scaleY = new Setting(this, "Scale Y", 1D, 0D, 3D);
	private Setting scaleZ = new Setting(this, "Scale Z", 1D, 0D, 3D);
